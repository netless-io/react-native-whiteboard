import type { Room } from 'react-native-whiteboard';
import type { Appliance, ApplianceShape, RoomMemberState } from '@netless/whiteboard-bridge-types';
import create, { StoreApi, UseBoundStore } from 'zustand';
import { rgbArrayToHex, rgbToHex } from '../utility';
